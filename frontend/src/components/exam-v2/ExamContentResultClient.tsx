...
export function ExamContentResultClient({ examId }: ExamContentResultClientProps) {
  ...
  const summary = useMemo(() => receipt ? fromReceipt(receipt) : session ? fromSession(session) : null, [receipt, session]);
