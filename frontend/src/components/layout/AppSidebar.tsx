...
export function AppSidebar() {
  ...
  const links = [
    ...
    { href: '/profile', label: 'Cài đặt', icon: Cog6ToothIcon },
  ];
  ...
  return (
    <aside className="sticky top-0 z-40 hidden h-[100dvh] w-64 shrink-0 flex-col border-r border-border bg-surface lg:flex">
      ...
      {/* Auth button moved to sidebar bottom or top header. Wait, design has avatar at top right of main content. Let's keep it empty here for now. */}
    </aside>
  );
}
