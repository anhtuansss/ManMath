...
examRouter.post('/v2/exams/:id/timing-sessions', optionalAuthMiddleware, startExamTimingSessionV2);
examRouter.get('/v2/exam-timing-sessions/:sessionId', optionalAuthMiddleware, getExamTimingSessionV2);
